...
The data for this homework assignment is *synthetic* data looking at different lifestyle and demographic variables and mental health/well-being for **42** people that are enrolled in **Company X's** wellness program. The following variables are included in the data:
